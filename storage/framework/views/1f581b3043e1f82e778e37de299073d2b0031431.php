	  ...
	  <div id="mobhead" class="mx-4 lg:flex lg:items-center navbar" style="margin-top: -6px;height: 121px;">
	    <div class="flex items-center justify-between">
	      <div class="lg:shrink-0">
	        <a href="<?php echo e(route('index')); ?>"><img src="assets/images/logo/liban.png" id="logostyle" alt="logo" style="width: 220px;height: auto;margin-top: -8px;"/></a>
	      </div>
	      ...
	      <ul style="color: white;margin-top:30px;" class="pb-2 lg:pb-0 lg:flex lg:flex-wrap lg:items-center lg:justify-end">
	      	<?php $__currentLoopData = $navdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					     <li class="font-bold lg:px-4 lg:py-2 lg:text-left p-2.5 text-[12.5px] text-right uppercase transition ease-in-out duration-300 hover:scale-105">
					     	<a style="font-family: 'Lato';font-size: 1rem;font-weight: 400;" href=<?php echo e($data['href']); ?>><?php echo e($data['text']); ?></a>
					     </li>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
@media  only screen and (max-width: 600px) {
  #navslide  {
	...
	<!-- Header Area End -->
<?php /**PATH C:\xampp\htdocs\restoapp\resources\views/home/partials/header.blade.php ENDPATH**/ ?>
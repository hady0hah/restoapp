...
>
  <div class="navbar-brand-wrapper d-flex align-items-center">
    <a href="{{ route('admin.index') }}">
      <img src="assets/images/logo/liban.png" style="height: auto;width: 146px;margin-bottom: -1em;" alt="logo" class="logo-dark w-32" />
    </a>
  </div>
  <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
    <h5 class="mb-0 font-weight-medium d-none d-lg-flex">
      Welcome to RestoApp admin dashboard!
    </h5>
    <ul class="navbar-nav navbar-nav-right ml-auto">
      <li>
        <a href="{{ route('index') }}" class="bedge-primary bg-amber-500 font-bold p-2.5 rounded text-white" target="_blank">Go To Dashboard</a>
      </li>
